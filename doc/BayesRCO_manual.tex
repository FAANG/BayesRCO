...
BayesRC      &  $\beta_i | a = A(i) \sim \sum_{K=1}^4\pi_{K,a}\mathcal{N}(0,k \sigma_g^2)$                      &4   & Yes, disjointed\\ 
BayesRC+     &           $\beta_i | a\in \mathbf{A}(i)\sim \alert{\sum_{a\in \mathbf{A}(i)}}\sum_{K=1}^4\pi_{K,a}N(0,k\sigma_g^2)$                 & 4   & Yes, overlapping     \\ 
BayesRC$\pi$ &        $\beta_i | a\in \mathbf{A}(i)\sim \alert{\sum_{a\in \mathbf{A}(i)}p_{i,a}}\sum_{K=1}^4\pi_{K,a}N(0,k\sigma_g^2)$                    &     4 & Yes, overlapping   \\  \\   \hline
    \end{tabular}}
\end{table}
